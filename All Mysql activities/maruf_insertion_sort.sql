...
--
-- Table structure for table `insertion_sort`
--

DROP TABLE IF EXISTS `insertion_sort`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `insertion_sort` (
